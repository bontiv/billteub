  ...
  <div class="panel-body">
    ...
    {if isset($smarty.session.user) && $smarty.session.user != false}
        ...
        <p>
          ...
          d'accès soient redéfinis : <a href="mailto:bureaulateb@googlegroups.com?subject=Accès Intra&body=Pouvez-vous vérifier mes accès sur l'intra...">contact@lateb.eu</a>.
        </p>
    {else}
        <p>
