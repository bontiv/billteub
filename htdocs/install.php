...
<html>
  <head>
    ...
    <!-- Css -->
    <link href="extmod/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
    <!-- /Css -->
    <!-- Scripts -->
    <script src="extmod/jquery/dist/jquery.min.js"></script>
    <script src="extmod/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- /Scripts -->
